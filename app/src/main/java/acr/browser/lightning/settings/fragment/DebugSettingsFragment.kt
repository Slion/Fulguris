...
import acr.browser.lightning.extensions.findViewByType
import acr.browser.lightning.extensions.onceOnLayoutChange
import acr.browser.lightning.extensions.snackbar
import acr.browser.lightning.settings.preferences.DeveloperPreferences
import acr.browser.lightning.settings.preferences.UserPreferences
import acr.browser.lightning.utils.FileUtils
import acr.browser.lightning.utils.Utils.startActivityForFolder
...
class DebugSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun openCrashLogsFolder() {
        startActivityForFolder(context, FileUtils.getFolderCrashLogs().absolutePath)
    }
