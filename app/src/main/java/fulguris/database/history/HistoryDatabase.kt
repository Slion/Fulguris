...
class HistoryDatabase @Inject constructor(
    ...
    private fun HistoryEntry.toContentValues() = ContentValues().apply {
        put(fulguris.database.history.HistoryDatabase.KEY_URL, url)
        put(fulguris.database.history.HistoryDatabase.KEY_TITLE, title)
        put(fulguris.database.history.HistoryDatabase.KEY_TIME_VISITED, lastTimeVisited)
    }
