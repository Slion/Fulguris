...
- **When:** 2026-09-15T06:42:06+00:00
...
- **Result:** 6/7 passed in 36.1s (1 ran, 6 carried forward)
...
| `test_cursor_fade_hides_then_wakes` | The cursor fades out after the inactivity timeout and wakes on movement | ✅ pass | 35.1s |
