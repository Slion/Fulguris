...
|------|----------|---------------|------------------|------------|--------|------------|--------|-------|
| 🇺🇸 | **English (Engineering)** | source | en-US | 610 | - | 100% | ✅ | Source strings |
...
| 🇮🇳 | **Hindi** | hi-rIN | hi-IN | 562 | 0 | 100% | ✅ | Newly added - Complete |
...
**Total Languages:** 40
**Languages with 26 issues:** 39 (98%) - All missing the same 26 new menu strings
**Languages 95%+ Complete:** 40 (100%)
...
python strings.py --set en-rUS string_id 'Updated text'

# 3. Then update all other language translations
python strings.py --set de-rDE string_id 'Aktualisierter Text'
```
...
python strings.py --set source settings 'Settings'

# Batch update English source strings
python strings.py --set source string1 'Value 1' string2 'Value 2'
