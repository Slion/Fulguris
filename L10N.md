...
| 🇹🇭 | **Thai** | th-rTH | <50 | ~92% | ✅ | 500+ strings translated with auto-add feature |
...
- **Auto-Add Missing Strings**: Automatically adds strings that don't exist in language files
...
**Auto-Add Feature:**
The tool automatically adds missing strings to language files. If a string ID doesn't exist in the target language file, it will be created automatically. This eliminates "string not found" errors and makes translation much easier.

**Single String:**
```bash
python l10n.py --set ko-rKR settings_title '설정'
# If settings_title doesn't exist, it will be added automatically
```
