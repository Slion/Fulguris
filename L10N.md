...
**L10N Tools:** The localization tools are maintained in a separate repository as a Git submodule at [`subs/l10n`](subs/l10n). For complete tool documentation, see [subs/l10n/docs/android/L10N.md](subs/l10n/docs/android/L10N.md).
...
python subs\l10n\android\strings.py --get ja-rJP app_name
python subs\l10n\android\strings.py --get zh-rCN app_name
python subs\l10n\android\strings.py --get ar-rSA app_name
```
...
python subs\l10n\android\strings.py --check ko-rKR

# FULL: Quality audit of all languages
python subs\l10n\android\strings.py --check --full

# FULL: Quality audit of specific language
python subs\l10n\android\strings.py --check th-rTH --full

# Either mode with near-match detection
python subs\l10n\android\strings.py --check ko-rKR --near 1
python subs\l10n\android\strings.py --check ko-rKR --full --near 1
```
...
python subs\l10n\android\strings.py --changed
```
...
python subs\l10n\android\strings.py --set string_id en-rUS 'Updated text'

# 3. Then update all other language translations
python subs\l10n\android\strings.py --set string_id de-rDE 'Aktualisierter Text' fr-rFR 'Texte mis à jour'
```
...
python subs\l10n\android\strings.py --sort

# Reorder a specific language
python subs\l10n\android\strings.py --sort ko-rKR
```
...
**Command Format:**
```bash
python subs\l10n\android\strings.py --set <string_id> <lang1> <value1> [<lang2> <value2> ...]
```
...
```bash
python subs\l10n\android\strings.py --set settings_title ko-rKR '설정'
...
```bash
python subs\l10n\android\strings.py --add settings_title 'Settings'
...
```bash
python subs\l10n\android\strings.py --raw --set match_x_of_n ko-rKR '<xliff:g id="current_match">%1$d</xliff:g>개 중'
```
...
python subs\l10n\android\strings.py --get source settings

# Update an existing English source string
python subs\l10n\android\strings.py --set settings source 'Settings'

# Update source and multiple languages at once
python subs\l10n\android\strings.py --set app_name source 'Fulguris' en-rUS 'Fulguris' en-rGB 'Fulguris'

# NOTE: To ADD new strings to English, use --add instead:
python subs\l10n\android\strings.py --add new_string 'New Value'
```
...
python subs\l10n\android\strings.py --add new_feature_name 'New Feature'
# Translators then use --set to add translations to their language files

# Remove a string from all language files
python subs\l10n\android\strings.py --remove obsolete_string_id
```
...
python subs\l10n\android\strings.py --get-plurals ko-rKR notification_incognito_running_title

# Set plural values
python subs\l10n\android\strings.py --set-plurals ko-rKR settings_summary_cookies \
...
```bash
python subs\l10n\android\strings.py --get ko-rKR settings_title
```
...
python subs\l10n\android\strings.py --set dialog_title ko-rKR '설정'

# Multiple languages at once (RECOMMENDED)
python subs\l10n\android\strings.py --set app_name de-rDE 'Fulguris' fr-rFR 'Fulguris' es-rES 'Fulguris'

# Strings with placeholders - single quotes work perfectly, $ is literal
python subs\l10n\android\strings.py --set dialog_title ko-rKR '%1$s 열기'

# Strings with double quotes - no escaping needed with single quotes!
python subs\l10n\android\strings.py --set session_switched ko-rKR '전환됨 "%s"'
...
python subs\l10n\android\strings.py --raw --set message_ssl_error sv-rSE 'Text:\n<xliff:g id="name" example="value">%1$s</xliff:g>'
```
...
python subs\l10n\android\strings.py --set test el-rGR "Don&apos;t"
# ERROR: Entity '&apos;' detected! Use \' instead.

# Invalid typo - will be rejected
python subs\l10n\android\strings.py --set test el-rGR "Test &pos; here"
# ERROR: Invalid entity '&pos;' detected! Use \' for apostrophes.

# Unquoted attribute - will be rejected
python subs\l10n\android\strings.py --raw --set test el-rGR '<xliff:g id=bad>%s</xliff:g>'
...
python subs\l10n\android\strings.py --raw --set message_ssl_error ro-rRO 'Text:\n<xliff:g id="domain_name" example="my.example.com"><b>%1$s</b></xliff:g>'
...
python subs\l10n\android\strings.py --raw --set test ro-rRO "Text:\n<xliff:g id=`"name`">%1`$s</xliff:g>"
```

❌ **WRONG - These break:**
```powershell
# Double quotes with backslash - PowerShell passes backslashes literally
python subs\l10n\android\strings.py --raw --set test el-rGR "text <xliff:g id=\"x\">%s</xliff:g>"
...
Text:\n\nMore text
'@
python subs\l10n\android\strings.py --raw --set test el-rGR $value
...
**Example:**
```bash
python subs\l10n\android\strings.py --set do_not_track vi-rVN "Yêu cầu &apos;Không theo dõi&apos;"
```
Output:
```
...
python subs\l10n\android\strings.py --set string_id th-rTH 'ดาวน์โหลด %s แล้ว'
# ✅ Has exactly one %s
```
...
python subs\l10n\android\strings.py --set string_id th-rTH 'ตรงกัน %1$d จาก %2$d'
...
python subs\l10n\android\strings.py --raw --set string_id th-rTH 'ตรงกัน <xliff:g id=\"current\">%1$d</xliff:g> จาก <xliff:g id=\"total\">%2$d</xliff:g>'
...
python subs\l10n\android\strings.py --set string_id th-rTH 'ดาวน์โหลดแล้ว'
...
python subs\l10n\android\strings.py --set string_id th-rTH 'ดาวน์โหลด %s ไฟล์'
...
```bash
python subs\l10n\android\strings.py --list
```
...
1. **Check Before Commit:** Run `python subs\l10n\android\strings.py --check` before committing
...
- Use: `python subs\l10n\android\strings.py --raw --set <lang> <id> <value>`
...
2. Run `python subs\l10n\android\strings.py --help` for command reference
3. Test translations with `python subs\l10n\android\strings.py --check <lang>`
...
python subs\l10n\android\strings.py --check el-rGR

# 4. Test get command
python subs\l10n\android\strings.py --get el-rGR show

# 5. Test get-plurals command
python subs\l10n\android\strings.py --get-plurals el-rGR notification_incognito_running_title
```
...
python subs\l10n\android\strings.py --set show el-rGR "Test &pos; here"
# Expected: ERROR - Invalid entity '&pos;' detected!

# Test 2: Invalid entity &apos; (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR "Don&apos;t use this"
# Expected: ERROR - Entity '&apos;' detected! Use \' instead.

# Test 3: Invalid entity &quot; (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR 'Text &quot;quoted&quot;'
# Expected: ERROR - Entity '&quot;' detected! Use \" instead.

# Test 4: Unquoted XML attribute (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR '<xliff:g id=bad>%s</xliff:g>'
# Expected: ERROR - Attribute value not quoted: id=bad

# Test 5: Mismatched XML tags (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR '<xliff:g>text</b>'
# Expected: ERROR - Mismatched tags

# Test 7: Unclosed XML tag (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR '<xliff:g id="test">text'
# Expected: ERROR - Unclosed tag(s)

# Test 8: Invalid custom entity (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR 'Text &custom; entity'
# Expected: ERROR - Invalid entity reference(s): &custom;

# Test 9: Unterminated entity (should FAIL)
python subs\l10n\android\strings.py --raw --set show el-rGR 'Text &amp more'
...
python subs\l10n\android\strings.py --set show el-rGR "Εμφάνιση"
# Expected: [OK] Successfully updated

# Test 2: Text with placeholder (should SUCCEED)
python subs\l10n\android\strings.py --set dialog_title el-rGR '%1$s settings'
# Expected: [OK] Successfully updated
...
'@
python subs\l10n\android\strings.py --raw --set match_x_of_n el-rGR $value
# Expected: [OK] Successfully updated

# Test 4: Valid entities (should SUCCEED)
python subs\l10n\android\strings.py --raw --set test el-rGR 'Text &amp; &lt; &gt; symbols'
# Expected: [OK] Successfully updated

# Test 5: Numeric entities (should SUCCEED)
python subs\l10n\android\strings.py --raw --set test el-rGR 'Text &#169; &#x1F4A1; entities'
# Expected: [OK] Successfully updated

# Test 6: Batch update multiple languages (should SUCCEED)
python subs\l10n\android\strings.py --set enable el-rGR 'Ενεργοποίηση' fr-rFR 'Activer' de-rDE 'Aktivieren'
# Expected: [OK] for all three languages

# Test 7: Plural update (should SUCCEED)
python subs\l10n\android\strings.py --set-plurals el-rGR notification_incognito_running_title other '%1$d tabs'
...
python subs\l10n\android\changelogs.py 239
```
...
python subs\l10n\android\strings.py --check <resource-code>
# Example: python subs\l10n\android\strings.py --check en-rGB

# 2. If missing, translate all strings (40 language batch recommended)
# Get list of string IDs to translate
python subs\l10n\android\strings.py --get source <string_id>

# 3. Translate each string across languages
python subs\l10n\android\strings.py --set <string_id> <resource-code> '<translation>'
# Example: python subs\l10n\android\strings.py --set app_name en-rGB 'Fulguris'
```
...
2. **Run changelogs.py**: `python subs\l10n\android\changelogs.py 239`
